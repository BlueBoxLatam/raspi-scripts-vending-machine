...
def start_ffmpeg():
    ...
    # Comando optimizado para WebRTC/MediaMTX
    # Sin segmentación HLS local, directo a streaming continuo.
    cmd = [
        'ffmpeg', 
        '-f', 'v4l2', 
        '-framerate', '15',
        ...
        '-preset', 'ultrafast',      
        '-tune', 'zerolatency',      
        '-g', '15',                  # Keyframe cada 1s (Ideal para WebRTC)
...
def main():
    ...
    print("\n🟢 [SYSTEM READY] Blue Box Vending v9 - WebRTC Mode")
