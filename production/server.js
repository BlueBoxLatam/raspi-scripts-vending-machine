...
// RUTA DE ESTADO (Para verificar que la API responde en el navegador)
app.get('/', (req, res) => {
    console.log("🔔 Ping HTTP recibido en raíz (/) - ¡Conexión Exitosa!");
    res.send('✅ Blue Box API v2.0 Online');
});
